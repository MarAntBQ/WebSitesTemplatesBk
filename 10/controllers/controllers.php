...
class Templatectr {
    public static function getPageNames() {
        ...
        $GLOBALS["WhatsApp-Link"] = "https://api.whatsapp.com/send?phone=593";
        $GLOBALS["Instagram-Link"] = "https://www.instagram.com/";
        $GLOBALS["Youtube-Link"] = "https://www.youtube.com/";
        $GLOBALS["Linkedin-Link"] = "https://www.linkedin.com/";
        $GLOBALS["Email-Link"] = "mailto:@";
        $GLOBALS["Phone-Link"] = "tel:+59399999999";
    }
}
